...
<head>
    ...
    <style>
        ...
        .card {
            ...
            border-left: 4px solid #dc2626; /* green for client CAP */
            border-radius: 8px;
            padding: 5px 15px;
            margin-bottom: 15px;
...
<body style="background-color: #fff; margin:0; padding:0;">
    <div class="container">
            ...
            <table width="100%">
                <tr>
                    ...
                    <td style="width:70%; height:30px;">
                        <h2 style="color:#1E3A8A; font-size:24px; margin:0;"> Corrective Action Plan</h2>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="info-section">
            ...
            <p><strong>Audit Date:</strong> {{ $auditCompany->date}}</p> 
        </div>

        <h5 class="title">Questions Answered with 'No'</h5>
